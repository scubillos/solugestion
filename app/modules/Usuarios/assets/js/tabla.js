$(document).ready(function () {
	...
	$(elem.idTable).jqGrid({
		...
		colModel: [
			...
			{ name: 'tipo_usuario', width: 60 },
			{ name: 'persona_contacto', width: 50 },
			{ name: 'num_percontacto', width: 50 },
			{ name: 'estado', width: 50, hidden:true },
			{ name: '', width: 50, align: 'center' },
			{ name: 'link', width: 150, hidden:true }
		],
		height: "auto",
		//autowidth: true,
		width: $(elem.idTable).parent().width() - 200,
